...
input[type=submit] {padding:10px 25px; background:whitesmoke; border:1 none;
    ...
    <center> <img style="position:absolute; left: 70px; top: 160px;"src="sale_256x256.png" width="450" height="450" alt="Coffee-break-icon" align="left"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <img src="cooltext1649123703.png" onmouseover="this.src='cooltext1649123703MouseOver.png';" onmouseout="this.src='cooltext1649123703.png';" />;
        
       <%--  <h2 ALIGN="center" style="font-family: COMIC SANS MS;font-size: 33px;text-shadow: 5px 5px 5px none">UPDATE EVENTS FORM</h2>--%>
        <form name="UPDATE EVENTS FORM" action="update events action.jsp" method="post">
    ...
    %>
                    <tr>
                        <td style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1"><b>EVENT NAME:<b></td>
                                    <td><input class="tb7" type="text" placeholder="Enter event name" name="EVENT NAME" value="<%=rs.getString(1)%>" size="35" required=""/></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1"><b>EVENT ID:</td>
                        <td><input class="tb7" type="text" placeholder="Enter Event ID" name="EVENT ID" value="<%=rs.getString(2)%>" size="35"READONLY="READONLY" required=""/></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1"><b>EVENT DESCRIPTION:</td>
                        <td><input class="tb7" type="text" placeholder="Enter Event Description" name="EVENT DESCRIPTION" value="<%=rs.getString(3)%>" size="35" required=""/></td>
                        <td></td>
                    </tr>
                   
                   <tr>
                        <td style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1"><b>EVENT  DATE:</td>
                        <td><input class="tb7" type="DATE" name="EVENT DATE" value="<%=rs.getString(4)%>" size="35" required=""/></td>
                        <td></td>
                    </tr>
                    <%}%>
                    <%-- <tr>
