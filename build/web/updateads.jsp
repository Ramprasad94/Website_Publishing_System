...
.text-glow a{
 ...
 body{
  ...
  .text1{
    ...
    <caption class="text1"><u>Advertisements Details</u></caption>
          <tr>
...
<th class="text-glow"><u>Advertisement Last date</u></th>
<th class="text-glow"><u>Delete ads</u></th>
<th class="text-glow"><u>Updates ads</u></th>
    ...
    <tr>
        ...
        <td><a  class="text2" style="text-decoration:none;" href="update ads form.jsp?id=<%=rs.getString(3)%>">Update</a></td>
    </tr>
    <%}%>
      </body>
</html>
