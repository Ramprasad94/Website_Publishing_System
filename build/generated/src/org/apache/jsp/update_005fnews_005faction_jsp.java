...
public final class update_005fnews_005faction_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int nid =Integer.parseInt(y);
            ...
            PreparedStatement ps = con.prepareStatement("update NEWS set Ntitle=?,Ncontent=?,Ndate Time=? where Nid='" + nid + "'");
