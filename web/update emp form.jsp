...
input[type=submit] {padding:10px 25px; background:whitesmoke; border:1 none;
    ...
    <center> <img style="position:absolute; left: 70px; top: 160px;"src="Coffee-break-icon.png" width="450" height="450" alt="Coffee-break-icon" align="left"/>
         ...
         <h2 ALIGN="center" style="font-family: COMIC SANS MS;font-size: 33px;text-shadow: 5px 5px 5px none">EMPLOYEE UPDATION FORM</h2>
        <form action="update emp action.jsp" method="post" name="EMPLOYEE REGISTRATION">
    ...
    %>           <tr>
                        <td style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1"><b>NAME:<b></td>
                                    <td><input class="tb7" type="text" name="NAME" placeholder="Enter Name" value="<%=rs.getString(1)%>" size="35" required=""/></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1"><b>EMPLOYEE ID:</td>
                        <td><input class="tb7" type="text" placeholder="Enter Employee ID" name="EMPLOYEE ID" value="<%=rs.getString(2)%>" size="35" readonly="readonly" required=""/></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1"><b>DATE OF BIRTH:</td>
                        <td><input type="date" name="DATE" class="tb7" value="<%=rs.getString(3)%>" required=""/></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1"><b>ADDRESS:</td>
                        <td><input class="tb7" placeholder="Enter Address" type="textarea" name="ADDRESS" value="<%=rs.getString(4)%>" size="35" required=""/></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1"><b>PHONE NUMBER:</td>
                        <td><input type="text" placeholder="Enter Address" name="PHONE NO" value="<%=rs.getString(5)%>" size="35" class="tb7" required="" min="8" max="13"/></td>
                        <td></td>
                    </tr>
                   <%-- <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" placeholder="Enter Department Name" name="DEPARTMENT" value="<%=rs.getString(7)%>" size="35" class="tb7" required=""/></td>
                        <td></td>
                    </tr>
                     <%--<tr>
                     ...
                     --%>                    
                      <tr>
                        ...
                        <td><input type="EMAIL" placeholder="Enter email address" name="EMAIL" value="<%=rs.getString(8)%>" size="35" class="tb7" required=""/></td>
                        <td></td>
                    </tr>  
                    <%}%>
                    <%--<tr>                          
