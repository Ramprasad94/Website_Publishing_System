...
input[type=submit] {padding:10px 25px; background:whitesmoke; border:1 none;
    ...
    <center> <img style="position:absolute; left: 70px; top: 160px;"src="sale_256x256.png" width="450" height="450" alt="Coffee-break-icon" align="left"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <img src="cooltext1649122680.png" onmouseover="this.src='cooltext1649122680MouseOver.png';" onmouseout="this.src='cooltext1649122680.png';" />;
        
       <%--  <h2 ALIGN="center" style="font-family: COMIC SANS MS;font-size: 33px;text-shadow: 5px 5px 5px none">UPDATE DEPARTMENT FORM</h2>--%>
        <form name="UPDATE DEPARTMENT FORM" action="update department action.jsp" method="post">
    ...
    ResultSet rs=st.executeQuery("select * from DEPARTMENT where DID='"+x+"'");
    while(rs.next())
    {
    %>
                    <tr>
                   
                        <td style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1"><b>DEPARTMENT NAME:<b></td>:<b></td>
                        <td><input class="tb7" type="text" name="DEPARTMENT NAME" value="<%=rs.getString(1)%>" placeholder="Enter Department Name" size="35" required=""/></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1"><b>DEPARTMENT ID:</td>
                        <td><input class="tb7" type="text" name="DEPARTMENT ID" value="<%=rs.getString(2)%>" placeholder="Enter Department ID" size="35"READONLY="READONLY" required=""/></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1"><b>NUMBER OF EMPLOYEES IN DEPARTMENT:</td>
                        <td><input class="tb7" type="text"  placeholder="Enter number of employees" name="NUMBER OF EMPLOYEES IN DEPARTMENT" value="<%=rs.getString(3)%>" size="35" required=""/></td>
                        <td></td>
                    </tr>
                   
                   <tr>
                        <td style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1"><b>DATE:</td>
                        <td><input class="tb7" type="DATE" name="DATE" value="<%=rs.getString(4)%>" size="35" required=""/></td>
                        <td></td>
                    </tr>
                    <%}%>
                    <%-- <tr>
