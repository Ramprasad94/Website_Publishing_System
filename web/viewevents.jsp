...
.text-glow a{
 ...
 %> 
    ...
    <caption class="text1"> Event Details</caption>
          <tr>
        <th class="text-glow"><u>Event Name</u></th>
<th class="text-glow"><u>Event ID</u></th>    
<th class="text-glow"><u>Event Description</u></th>
<th class="text-glow"><u> Event Date</u></th>
<th class="text-glow"><u>Delete events</u></th>
    ...
    <tr>
        ...
        <td><a class="text2" style="text-decoration:none;" href="delevent.jsp?id=<%=rs.getString(2)%>">Delete</a></td> 
