...
$(document).ready(function(){
    ...
    <center><img style="position:absolute; left: 70px; top: 160px;"src="boxes-brown-icon.png" width="450" height="450" alt="Coffee-break-icon" align="left"/>
        ...
        <form name="ADD PRODUCTS" action="product_action.jsp" method="post">
            <table border="0" align="right" width="700" >
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input class="tb7" type="text" placeholder="Enter Product Name" name="NAME" value="" size="35" required="" /></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1"><b>PRODUCT ID:</td>
                        <td><input class="tb7" type="text" placeholder="Enter Product ID" name="PID" value="" size="35" required="" /></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1"><b>PRICE OF PRODUCT:</td>
                        <td><input class="tb7" type="text" name="PRICE" placeholder="Enter Product Price" value="" size="35" required="" /></td>
                        <td></td>
                    </tr>
                    <tr>
                   ...
                   <tr>
                        ...
                        <td><input class="tb7" type="DATE" name="date" value="" size="35" required="" /></td>
                        <td></td>
                    </tr>
                     <tr>
