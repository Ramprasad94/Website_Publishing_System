...
$(document).ready(function(){
    ...
    <center><img style="position:absolute; left: 70px; top: 160px;"src="voice-chat-icon.png" width="450" height="450" alt="Coffee-break-icon" align="left"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <img src="cooltext1640316446.png" onmouseover="this.src='cooltext1640316446MouseOver.png';" onmouseout="this.src='cooltext1640316446.png';" />;
        
        <%-- <h2 ALIGN="center" style="font-family: COMIC SANS MS;font-size: 33px;text-shadow: 5px 5px 5px none">EMPLOYEE REGISTRATION</h2>--%>
        <form name="ADD EVENTS" action="EVENT_ACTION.jsp" method="post" >
            <table border="0" align="right" width="700" >
                ...
                <tbody>
                    <tr>
                        <td style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1"><b>EVENT NAME:<b></td>
                        <td><input class="tb7" type="text" placeholder="Enter event name" name="EVENT_NAME" value="" size="35" required pattern="[a-zA-Z]+" /></td>
                        <td></td>
                    </tr>
                      <tr>
                        <td style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1"><b>EMPLOYEE ID:</td>
                        <td><input class="tb7" type="text" placeholder="Enter Employee ID" name="EMPLOYEE ID" value="<%=session_id%>" size="35"readonly="readonly" required="" />
                                   <%                           
                    ...
                    <tr>
                        <td style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1"><b>EVENT DESCRIPTION:</td>
                        <td><textarea name="DESCRIPTION" placeholder="Enter event description" rows="5" cols="27" class="tb9" required pattern="[a-zA-Z]+" >
                            </textarea></td>
                        <td></td>
                    </tr>
                 
                    <tr>
                        <td style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1"><b>EVENT DATE:</td>
                        <td><input class="tb7" type="date" name="EVENT_DATE" value="" size="35" required="" /></td>
                        <td></td>
                    </tr>
                     ...
                     <tr>
                  <td></td>
                        <td><input style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1" type="submit" name="submit" value="Submit" size="35" /><input style="font-family: Agency FB;text-shadow: 3px 3px 3px none;font-size: 27px" class="text1" class="text1" type="reset" name="reset" value="Reset" size="35" /></td>
                    </tr>    
                </tbody>
            </table>
